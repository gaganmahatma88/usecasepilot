        ...
        <div className="max-w-2xl">
          ...
          <div className="flex gap-3 mb-6">
            ...
            <input
              ...
              className="w-24 border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
              ...
              {ideas.map((idea, i) => (
                <li key={i}>
                  <button
                    ...
                    className="w-full text-left px-4 py-3 bg-gray-50 hover:bg-blue-50 hover:text-blue-700 border border-gray-100 rounded-lg text-sm text-gray-800 transition-colors"
                  >
                    {idea}
                  </button>
                </li>
